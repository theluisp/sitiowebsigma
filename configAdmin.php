...
<head>    <link rel="shortcut icon" href="img/sigmad.png">

    <title>Admin</title>
    <?php include './inc/link.php'; ?>
    <script type="text/javascript" src="js/aadmin.js"></script>
</head>
    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
                <h1>Panel de administración <small class="tittles-pages-logo">- SIGMA</small></h1>
            </div>
            <!-- Nav tabs -->
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="#Categoriasa" role="tab" data-toggle="tab">Categorías</a></li>
            ...
            <div class="tab-content"> 
                <div role="tabpanel" class="tab-pane fade" id="Pedidos">
                    <div class="row">
                   <?php 
                  $pedidos= "select * from pedidos_tienda";
                         $resultped = $conn->query($pedidos);
                        echo '<table  class="table"><tr><th>id_usuario</th><th>  Producto </th><th>  Modelo </th><th> Precio </th><th>  Fecha </th></tr>';
                                        while($catecp = $resultped->fetch_assoc()){
                                            echo "<tr>";
                                            echo "<td>".$catecp['user_id']."</td>";
                                             echo "<td>".$catecp['nombre']."</td>";
                                            
                                             echo "<td>".$catecp['modelo']."</td>";
                                             echo "<td>".$catecp['precio']."</td>";
                                             echo "<td>".$catecp['fecha']."</td>";
                                            echo "</tr>";
                                        }
                        echo "</table>";
                        ?>
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="Productos">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <br><br>
                            <div id="add-product">
                                <h2 class="text-primary text-center"><small><i class="fa fa-plus"></i></small>&nbsp;&nbsp;Agregar producto nuevo</h2>
                                <form role="form" action="process/regproduct.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="prod-categoria">
                                            <?php 
                                        $categoriac= "select * from categoria";
                                        $result = $conn->query($categoriac);
                                        while($catec = $result->fetch_assoc()){
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Modelo y marca" required maxlength="30" name="prod-model">
                                    </div>
                                   
                                      <div class="form-group">
                                        <label>Descripción</label>
                                        <input type="text" class="form-control" placeholder="Descripción" required maxlength="530" name="descripcion">
                                    </div>
                                    
                                    <div class="form-group">
                                        <input type="hidden" class="form-control" name="nombre" id="nombre" value="admin">
                                    </div>
                                    
                                    
                                      <div class="form-group">
                                        <label>Link mercado libre</label>
                                        <input type="text" class="form-control" placeholder="Link mercado libre"  maxlength="330" name="mercadolibre">
                                    </div>
                                      <div class="form-group">
                                        <label>Color</label>
                                        <input type="text" class="form-control" placeholder="Color" required maxlength="30" name="color">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="prod-codigoP">
                                            <?php 
                                        $proveedoresc= "select * from proveedor";
                                        $result2 = $conn->query($proveedoresc);
                                        while($provc = $result2->fetch_assoc()){
                                    ...
                                    <div class="form-group">
                                        <label>Imagen de producto 1</label>
                                        <input type="file" name="img">
                                        <p class="help-block">Formato de imagenes admitido png, jpg, gif, jpeg</p>
                                    </div>
                                                                        <div class="form-group">
                                        <label>Imagen de producto 2</label>
                                        <input type="file" name="img2">
                                        <p class="help-block">Formato de imagenes admitido png, jpg, gif, jpeg</p>
                                    </div>
                                    <div class="form-group">
                                        <label>Imagen de producto 3</label>
                                ...
                                <form action="process/delprod.php" method="post" role="form">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="prod-code">
                                            <?php 
                                             $productoc=  "select * from producto";
                                       $result3 = $conn->query($productoc);
                                             while($prodc = $result3->fetch_assoc()){
                                    ...
                                    <table class="table table-bordered">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th class="text-center">Modelo y marca</th>
                                        ...
                                        $resultall = $conn->query($productos);
                                        $upr=1;
                                      
                                        while($prod = $resultall->fetch_assoc()){
                                            echo '
                                                <div id="update-product">
                                                  <form method="post" action="process/updateProduct.php" id="res-update-product-'.$upr.'">
                                                    <tr>
                                                        ...
                                                        <td>';
                                                            $categoriac3="select * from categoria where CodigoCat='".$prod['CodigoCat']."' ";
                                                           $resultall2 = $conn->query($categoriac3); 
                                                        while($catec3= $resultall2->fetch_assoc()){
                                                      ...
                                                      echo '<select class="form-control" name="prod-category">';
                                                                ...
                                                                $categoriac22= "select * from categoria";
                                                                $resultcodigo= $conn->query($categoriac22);
                                                                while($catec2=$resultcodigo->fetch_assoc()){
                                                      ...
                                                      echo '</select>
                                                        ...
                                                        <td><input class="form-control" type="text-area" name="marc-prod" maxlength="30" required="" value="'.$prod['Marca_y_modelo'].'"></td>
                                                         <td><input class="form-control" type="text-area" name="marc-prod" maxlength="30" required="" value="'.$prod['color'].'"></td>
                                                        <td><input class="form-control" type="text-area" name="stock-prod" maxlength="30" required="" value="'.$prod['Stock'].'"></td>
                                                        <td>';
                                                           $proveedoresc3= "select * from proveedor where NITProveedor='".$prod['NITProveedor']."'";
                                                           
                                            $proveedor2101= $conn->query($proveedoresc3);
                                            while($provc3=$proveedor2101->fetch_assoc()){
                                                       ...
                                                       echo '<select class="form-control" name="prod-Prove">';
                                                                ...
                                                                $proveedoresc2=  "select * from proveedor";
                                                               $nitproveedor=$conn->query($proveedoresc2); while($provc2=$nitproveedor->fetch_assoc()){
                                                       ...
                                                       echo '</select>
                                                        </td> <td><input class="form-control" type="text-area" name="marc-prod" maxlength="30"  value="'.$prod['link_mercado'].'"></td>
                                                         <td><textarea class="form-control" type="text-area" name="marc-prod" cols="80" rows="3" required="" value="'.$prod['descripcion'].'">
                                                        '.$prod['descripcion'].';
                                                         </textarea>
                                ...
                                <form action="process/delprove.php" method="post" role="form">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="nit-prove">
                                            <?php 
                                            $proveNIT= "select * from proveedor";
                                            $ejecutarpro=$conn->query($proveNIT);
                                            while($PN=$ejecutarpro->fetch_assoc()){
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $proveedoresmysql=$conn->query($proveedores);
                                              $up=1;
                                              while($prov=$proveedoresmysql->fetch_assoc()){
                                                  echo '
                ...
                <!--==============================Panel Categorias===============================-->
                <div role="tabpanel" class="tab-pane fade" id="Categoriasa">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <br><br>
                            <div id="add-categori">
                                ...
                                <form action="process/delcategori.php" method="post" role="form">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="categ-code">
                                            ...
                                            $querycateg =$conn->query($categoriav);
                                                while($categv=$querycateg->fetch_assoc()){
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                              ...
                                              $querycategorias = $conn->query($categorias);
                                              $ui=1;
                                              while(($cate=$querycategorias ->fetch_assoc())){
                                                  echo '
